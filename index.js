...
// middlewire
const loggger = async (req,res,next) => {
...
async function run() {
  try {
    ...
    // auth related api
    app.post('/jwt',loggger, async (req,res) => {
      const user = req.body;
      // console.log(user);
    ...
    app.get('/services',loggger, async(req,res) => {
    ...
    app.get('/bookings', verifyToken, async(req,res)=> {
      ...
      console.log("from user of the valid token", req.user);
